...
public class TestsTurnService {
    ...
    public void TestMovementsPawn() {
        ...
        Pawn opponentPawnOne = new Pawn(Color.White);
        opponentPawnOne.setPosition(new Position(2, 2));
        Pawn opponentPawnTwo = new Pawn(Color.White);
        ...
        Movement[] arrayOfMovementsExpected = new Movement[1];
        arrayOfMovementsExpected[0] = new Movement(new Position(3, 1), pawn.getPosition(), Direction.FREnPasse);

        // get data for testList
        Movement[] arrayOfMovementActual = turnService.getPossibleTurnFor(dicPosPiece, pawn);
    ...
    public void TestMovementsRock() {
        ...
        Rock opponentPawnOne = new Rock(Color.White);
        ...
        Movement[] arrayOfMovementsExpected = new Movement[14];
        ...
        // get data for testList
        Movement[] arrayOfMovementActual = turnService.getPossibleTurnFor(dicPosPiece, rock);
    ...
    public void TestMovementsQueen() {
        ...
        Movement[] arrayOfMovementsExpected = new Movement[21];
        ...
        // get data for testList
        Movement[] arrayOfMovementActual = turnService.getPossibleTurnFor(dicPosPiece, queen);
    ...
    public void TestMovementsKing() {
        ...
        Movement[] arrayOfMovementsExpected = new Movement[3];
        ...
        // get data for testList
        Movement[] arrayOfMovementActual = turnService.getPossibleTurnFor(dicPosPiece, king);
